...
23. 默认用微信助理 ClawBot 推送日报全文。
24. 如果 ClawBot 未配置，不要伪造推送成功；贴出日报全文，并指导我在 WorkBuddy GUI 里绑定 ClawBot。
25. 首次手动跑通后，读取 `docs/automation-setup.md`，指导我在 WorkBuddy GUI 里创建 Automation，每天 07:30 运行。
